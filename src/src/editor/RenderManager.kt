...
private suspend fun executeAndReadOutput(
    command: GeneralCommandLine,
    logErrorIfBadExitCode: Boolean = true
): Pair<Int, StringBuilder> {
...
private fun getThemeId(request: RenderRequest): String? {
    val theme = request.theme
        ?: return if (JBColor.isBright()) {
            ...
            EnvironmentUtil.getValue("D2_DARK_THEME")?.takeIf { it.isNotBlank() } ?: "200"
        }
